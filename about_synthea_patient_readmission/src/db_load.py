...
from config.settings import DB_CONFIG, GDRIVE_FOLDER_URL
...
# download data
logging.info("Starting Google Drive download")
start = time.time()
...
logging.info(
    f"Download finished in {round(time.time() - start, 2)} seconds"
)
